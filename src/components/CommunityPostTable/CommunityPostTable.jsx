      ...
      {posts.length === 0 ? (
        ...
        <div>
          {posts.map((post) => (
            ...
            >
              <span className="w-20 md:w-28 text-xs md:text-sm text-gray-600">{post.date}</span>
              ...
              <span className="w-16 md:w-24 text-xs md:text-sm text-gray-600 text-center">{post.author}</span>
              <span className="w-12 md:w-20 text-xs md:text-sm text-gray-600 text-center">{post.views}</span>
            </div>
          ))}
        </div>
      )}
